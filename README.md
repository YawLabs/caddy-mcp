...
npm test           # Vitest (773 unit tests, +39 POSIX-only unix-socket and launcher tests; +38 live-Caddy integration tests gated by CADDY_MCP_INTEGRATION=1)
